  ...
  return (
    <div className="min-h-screen">
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950/30">
        {/* Enhanced Header */}
        <header className="fixed top-0 w-full z-50 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-800/50 shadow-sm">
        ...
        <section className="pt-32 pb-20 px-6 relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950/30">
          ...
          <div className="container mx-auto text-center max-w-6xl relative">
            ...
            <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 mb-12 max-w-4xl mx-auto leading-relaxed font-medium">
              Find Your Direction in 30 Days. The only platform that teaches you
              HOW to learn coding—not just what to learn.
            </p>
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-12 max-w-3xl mx-auto leading-relaxed">
              ...
              tutorial hell, jumping from course to course without real
              progress. gigaCodeX is your escape route—a learning compass that
              transforms confusion into confidence.
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <button className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white rounded-2xl font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-xl shadow-blue-500/25 hover:shadow-2xl hover:shadow-blue-500/40 overflow-hidden">
        ...
        <section className="py-24 px-6 bg-gradient-to-br from-slate-100 via-white to-blue-100/50 dark:from-slate-900/50 dark:via-slate-950 dark:to-blue-950/30">
        ...
        <section className="py-24 px-6 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 dark:from-slate-900/50 dark:via-slate-950 dark:to-blue-950/30">
        ...
        {/* Enhanced Footer */}
        <footer className="bg-gradient-to-br from-white via-slate-50 to-blue-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950/30 border-t border-slate-200 dark:border-slate-800 py-20 px-6">
          <div className="container mx-auto max-w-7xl">
