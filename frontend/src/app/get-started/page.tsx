import { ArrowRight, Compass, MapPin, Target, Sparkles } from "lucide-react";
        ...
        <div className="container mx-auto max-w-3xl relative">
          <div className="text-center mb-16">
            ...
            <Link
              ...
              className="group relative inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-2xl font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-xl shadow-blue-500/25 hover:shadow-2xl hover:shadow-blue-500/40"
            >
